...
const details: Record<string, CatalogVerifiedDetails> = {
  ...
  "hacksaw-gaming-ronin-stackways": {
    field: "5×4 · до 100 000 способов",
    rtp: "96,35% / 94,33% / 92,24% / 88,23%",
    maxWin: "5 000x",
    volatility: "2/5",
